...
const totalSections = 8;  // Изменили с 7 на 8
let score = 0;
...
function showFinalResults() {
    ...
    if (!r) {
        ...
        r.innerHTML = `<div class="final-score"><h2>Урок завершён!</h2><div class="score-value" id="finalScore">0</div><p>очков набрано</p><div id="achievements"></div></div>
            ...
            <li>Создание и особенности списков</li><li>Индексацию и срезы списков</li>
            <li>Методы добавления: append, extend, insert</li><li>Методы удаления: remove, pop, clear</li>
            <li>Перебор списков циклом for</li><li>Полезные методы: sort, reverse, count, index, copy</li>
            <li>Операции со списками</li></ul></div>
    ...
    a.innerHTML = '';
    if (correctAnswers >= 15) a.innerHTML += '<span class="achievement">🏆 Мастер списков</span>';
