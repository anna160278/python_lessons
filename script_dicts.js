...
function showFinalResults() {
    ...
    if (!r) {
        ...
        r.innerHTML = `<div class="final-score"><h2>Урок завершён!</h2><div class="score-value" id="finalScore">0</div><p>очков набрано</p><div id="achievements"></div></div>
            ...
            <li>Кортежи (tuple) — неизменяемые последовательности</li><li>Индексация, срезы и перебор кортежей</li>
            <li>Распаковка кортежей в переменные</li><li>Словари (dict) — пары ключ:значение</li>
            <li>Методы словарей: get, keys, values, items, update, pop</li><li>Перебор словарей циклом for</li>
            <li>Использование кортежей как ключей словарей</li></ul></div>
    ...
    a.innerHTML = '';
    if (correctAnswers >= 15) a.innerHTML += '<span class="achievement">🏆 Мастер</span>';
