...
function showFinalResults() {
    ...
    if (!r) {
        ...
        r.innerHTML = `<div class="final-score"><h2>Урок завершён!</h2><div class="score-value" id="finalScore">0</div><p>очков набрано</p><div id="achievements"></div></div>
            ...
            <li>Цикл while и его применение</li><li>Цикл for и функция range()</li><li>Перебор строк посимвольно</li>
            <li>Управление циклами: break, continue</li><li>Вложенные циклы и паттерны</li></ul></div>
    ...
    a.innerHTML = '';
    if (correctAnswers >= 15) a.innerHTML += '<span class="achievement">🏆 Мастер циклов</span>';
