...
function showFinalResults() {
    ...
    if (!r) {
        ...
        r.innerHTML = `<div class="final-score"><h2>Урок завершён!</h2><div class="score-value" id="finalScore">0</div><p>очков набрано</p><div id="achievements"></div></div>
            ...
            <li>Арифметические операции: +, -, *, /</li><li>Целочисленное деление // и остаток %</li><li>Возведение в степень **</li>
            <li>Условия if, elif, else</li><li>Логические операторы and, or, not</li></ul></div>
